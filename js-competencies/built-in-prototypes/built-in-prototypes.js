...
//Code here
const dragonMapper = array => array.map(elm => (elm += "...here be dragons"));
...
const cookieLoversOnly = array => array.filter(elm => elm.favoriteCookie);
...
const changeValue = (array, callback) =>
...
const findProduct = array => array.reduce((acc, curr) => acc * curr); // anything times zero is zero

// console.log(findProduct(lah));
//////////////////PROBLEM 5////////////////////
...
//Code here
const cipherize = (array, string) => string.charAt(array.indexOf(string));
