...
annePromotion = careerUpdater("Anne", "Windsor", "Lady-In-Waiting");
//Code here
//Call annePromotion with the arguments "London", "Queen". Store the
//result in a variable called "anneResumeEntry1"

anneResumeEntry1 = annePromotion("London", "Queen");
//Code here
// anneResumeEntry2 = annePromotion("Tower of London dungeons");
...
claraResumeEntry = claraPromotion("Seattle", "programmer");
//Code here
